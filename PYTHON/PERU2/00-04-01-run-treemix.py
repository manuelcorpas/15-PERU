...
treemix_output = 'ANALYSIS/13-TREEMIX/treemix_AFRO_DES_k1000_m3'  # Output file prefix

# Step 2: Run TreeMix
# Root: AFRO_DES
# Grouped together SNPs to account for LD (-k)
# Build the ML G graph with 10 migration events
treemix_command = f'treemix -i {input_file} -root AFRO_DES -k 1000 -m 3 -o {treemix_output}'
#subprocess.run(treemix_command, shell=True)

tree = extract_and_read_tree("ANALYSIS/13-TREEMIX/treemix_AFRO_DES_k1000_m3.treeout.gz")
