...
def plot_pca_results(pca_file, population_file):
    ...
    plt.xlabel('PC1')
    plt.ylabel('PC2')
    plt.title('PCA of Non-Castillian Languages (151 Samples, 8 Languages)')
    plt.legend()
...
def main():
    ...
    population_file = 'ANALYSIS/10-PCA/ii_languages.txt'  # Path to the file mapping samples to populations
