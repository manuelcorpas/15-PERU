...
K = 3  # Adjust the number of populations as necessary
admixture_output_file = plink_format_output+'_pruned.' + str(K))
subprocess.run([admixture_executable_path, 'plink_format_output_pruned.bed', str(K), '-j8', '-o', admixture_output_file])
